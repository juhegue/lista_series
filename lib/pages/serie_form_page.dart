...
var _kImageBase64 = (defaultTargetPlatform == TargetPlatform.android)
    ? _kImageBase64Galeria
    : _kImageBase64Clipboar;
...
class _SerieFormPageState extends State<SerieFormPage> {
  ...
  Future getImageSource(ImageSource media) async {
    try {
  ...
  Future getImageSourceClipboard() async {
